# This file will install the various pull-xxx-samples for use in training and demo purposes.
# This script and the other files should be placed into C:\tools\pull-samples
# then run this bat file to put the other files in their correct places.
#
